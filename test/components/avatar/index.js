...
describe('<Avatar />', () => {
  ...
  it('with letters', () => {
    ...
    assert.equal(
      wrapper.prop('className'),
      'avatar round_circle avatar_fill_light_grey text_primary',
    );
    assert.equal(
      wrapper.prop('style').lineHeight,
      '38px',
    );
  });
  ...
  it('change theme', () => {
    ...
    assert.equal(
      wrapper.prop('className'),
      'avatar round_circle avatar_stroke_secondary text_black',
    );
  });
  ...
  it('with className', () => {
    ...
    assert.equal(
      wrapper.prop('className'),
      'avatar round_circle my-className',
    );
  });
});
