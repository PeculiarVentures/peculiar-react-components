...
describe('<Avatar />', () => {
  ...
  it('render with image', () => {
    const wrapper = mount(<Avatar src={imgLink} />, global.defaultComponentOptions);

    expect(wrapper.find('[data-component="avatar"]').exists()).toBe(true);
  ...
  it('with className', () => {
    ...
    expect(wrapper.find('div')
      .prop('className'))
      .toBe('avatar round_circle avatar_fill_light_grey text_primary my_custom_class');
  });
});
