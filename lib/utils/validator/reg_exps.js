 ...
 */
const smiles = '\u00a9\u00ae\u2000-\u3300\ud83c\ud000-\udfff\ud83d\ud000-\udfff\ud83e\ud000-\udfff';
const nonLetterCh = '\u0021-\u0040\u005B-\u0060\u007B-\u00BF\u02B9-\u0362\u1FFD-\u2BFF';
const allowedNameCh = "'";
const nameRegExp = new RegExp(`^(([^${nonLetterCh}${smiles}\\s]|${allowedNameCh})+(\\s|-))*([^${nonLetterCh}${smiles}\\s]|${allowedNameCh})+$`, 'i');
const lettersRegExp = new RegExp(`^([^${nonLetterCh}${smiles}\\s'])+$`, 'i');
